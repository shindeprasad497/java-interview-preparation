# 15. Web, REST & Reactive APIs (Spring WebFlux)
...
## 📌 Chapter Overview
This module covers the **Spring MVC request lifecycle**, REST API design standards (Richardson Maturity Model), global error handling with **RFC 7807 `ProblemDetail`**, modern HTTP clients (**`RestClient`**, Declarative `@HttpExchange`), and **Spring WebFlux**.
...
## 2. REST API Standards & RFC 7807 `ProblemDetail`

### Q1. How do you implement production Global Exception Handling using RFC 7807?
**Answer:**
...
## 3. Modern HTTP Clients in Spring Boot 3
...
### Q2. Compare `RestClient` (Boot 3) vs. Declarative `@HttpExchange`.
**Answer:**
...
## 4. Reactive Programming: Spring WebFlux vs. Spring MVC

### Q3. When should you choose Spring WebFlux over Spring MVC with Virtual Threads?
**Answer:**
